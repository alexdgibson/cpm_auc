...
term_1 <- sprintf('(%s) AND ("2025/01/01"[Date - Publication] : "2025/01/31"[Date - Publication])', search_filter)
...
# this is the total number of articles on pubmed in the last 12 months with the search term 
...
# save screening data
save(screening_data, file = "02_data/screening_data.Rdata")
